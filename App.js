...
// )
const Cash = (props) => (
    <div className="result">{props.title} <span className="cash">{props.cash <= 0 ? "" : (props.cash / props.ratio * props.price).toFixed(2)}</span></div>
    ...
    render() {
        ...
        return (
            <div className="app">
                ...
                <br />
                <label>
                    <input type="number" placeholder="wprowadź wartość" value={this.state.amount} onChange={this.handleChange} />
